...
Originally a programming principles assignment, part of CS degree at Bar Ilan university.
...
**End-to-End Walkthrough of `(\x. x * 2) 21` # In standard lambda calculus (λx.x*2)21**:
